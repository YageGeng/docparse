...
unsafe extern "system" fn sys_allocator_alloc(
    _this: *mut ort_sys::OrtAllocator,
    _size: usize,
) -> *mut c_void {
    ptr::null_mut()
}

unsafe extern "system" fn sys_allocator_free(
    _this: *mut ort_sys::OrtAllocator,
    p: *mut c_void,
) {
...
unsafe extern "system" fn sys_allocator_info(
...
unsafe extern "system" fn sys_allocator_reserve(
    _this: *const ort_sys::OrtAllocator,
    _size: usize,
) -> *mut c_void {
    ptr::null_mut()
}
