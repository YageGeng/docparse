...
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_UNKNOWN:
    FPDF_TEXT_RENDERMODE = -1;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_FILL: FPDF_TEXT_RENDERMODE =
    0;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_STROKE:
    FPDF_TEXT_RENDERMODE = 1;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_FILL_STROKE:
    FPDF_TEXT_RENDERMODE = 2;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_INVISIBLE:
    FPDF_TEXT_RENDERMODE = 3;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_FILL_CLIP:
    FPDF_TEXT_RENDERMODE = 4;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_STROKE_CLIP:
    FPDF_TEXT_RENDERMODE = 5;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_FILL_STROKE_CLIP:
    FPDF_TEXT_RENDERMODE = 6;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_CLIP: FPDF_TEXT_RENDERMODE =
    7;
pub const FPDF_TEXT_RENDERMODE_FPDF_TEXTRENDERMODE_LAST: FPDF_TEXT_RENDERMODE =
    7;
...
pub type FPDF_STRUCTELEMENT_ATTR_VALUE =
    *const fpdf_structelement_attr_value_t__;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const FPDF_FONT_BACKEND_TYPE_FPDF_FONTBACKENDTYPE_FREETYPE:
    FPDF_FONT_BACKEND_TYPE = 0;
pub const FPDF_FONT_BACKEND_TYPE_FPDF_FONTBACKENDTYPE_FONTATIONS:
    FPDF_FONT_BACKEND_TYPE = 1;
...
pub struct FPDF_FILEHANDLER_ {
    ...
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(clientData: *mut ::std::os::raw::c_void),
    >,
...
unsafe extern "C" {
    pub fn FPDF_GetDocPermissions(
        document: FPDF_DOCUMENT,
    ) -> ::std::os::raw::c_ulong;
}
unsafe extern "C" {
    pub fn FPDF_GetDocUserPermissions(
        document: FPDF_DOCUMENT,
    ) -> ::std::os::raw::c_ulong;
}
unsafe extern "C" {
    pub fn FPDF_GetSecurityHandlerRevision(
        document: FPDF_DOCUMENT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDF_VIEWERREF_GetPrintScaling(document: FPDF_DOCUMENT)
    -> FPDF_BOOL;
}
unsafe extern "C" {
    pub fn FPDF_VIEWERREF_GetNumCopies(
        document: FPDF_DOCUMENT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDF_VIEWERREF_GetPrintPageRangeCount(
...
unsafe extern "C" {
    pub fn FPDF_VIEWERREF_GetDuplex(document: FPDF_DOCUMENT)
    -> FPDF_DUPLEXTYPE;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFText_GetSchResultIndex(
        handle: FPDF_SCHHANDLE,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn FPDFText_GetSchCount(
        handle: FPDF_SCHHANDLE,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPageObj_HasTransparency(
        page_object: FPDF_PAGEOBJECT,
    ) -> FPDF_BOOL;
}
unsafe extern "C" {
    pub fn FPDFPageObj_GetType(
        page_object: FPDF_PAGEOBJECT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPageObj_GetMarkedContentID(
        page_object: FPDF_PAGEOBJECT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn FPDFPageObj_CountMarks(
        page_object: FPDF_PAGEOBJECT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPageObjMark_CountParams(
        mark: FPDF_PAGEOBJECTMARK,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFImageObj_GetBitmap(image_object: FPDF_PAGEOBJECT)
    -> FPDF_BITMAP;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFImageObj_GetImageFilterCount(
        image_object: FPDF_PAGEOBJECT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPageObj_SetBlendMode(
        page_object: FPDF_PAGEOBJECT,
        blend_mode: FPDF_BYTESTRING,
    );
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPageObj_GetLineJoin(
        page_object: FPDF_PAGEOBJECT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPageObj_GetDashCount(
        page_object: FPDF_PAGEOBJECT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFPathSegment_GetType(
        segment: FPDF_PATHSEGMENT,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFTextObj_SetFontSize(
        text: FPDF_PAGEOBJECT,
        size: f32,
    ) -> FPDF_BOOL;
}
...
unsafe extern "C" {
    pub fn FPDFTextObj_GetTextRenderMode(
        text: FPDF_PAGEOBJECT,
...
unsafe extern "C" {
    pub fn FPDFFont_GetItalicAngle(
        font: FPDF_FONT,
...
unsafe extern "C" {
    pub fn FPDFFont_GetCharGlyphIndex(
        font: FPDF_FONT,
        char_code: u32,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn FPDFGlyphPath_CountGlyphSegments(
...
unsafe extern "C" {
    pub fn FPDFFormObj_CountObjects(
...
unsafe extern "C" {
    pub fn FPDFLink_GetLinkZOrderAtPoint(
        page: FPDF_PAGE,
        x: f64,
        y: f64,
    ) -> ::std::os::raw::c_int;
...
unsafe extern "C" {
    pub fn FPDFLink_CountQuadPoints(
        link_annot: FPDF_LINK,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub struct _FPDF_FORMFILLINFO {
    pub version: ::std::os::raw::c_int,
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO),
    >,
...
unsafe extern "C" {
    pub fn FORM_SelectAllText(
        hHandle: FPDF_FORMHANDLE,
        page: FPDF_PAGE,
    ) -> FPDF_BOOL;
}
unsafe extern "C" {
    pub fn FORM_CanUndo(hHandle: FPDF_FORMHANDLE, page: FPDF_PAGE)
    -> FPDF_BOOL;
}
unsafe extern "C" {
    pub fn FORM_CanRedo(hHandle: FPDF_FORMHANDLE, page: FPDF_PAGE)
    -> FPDF_BOOL;
}
unsafe extern "C" {
...
pub const FPDFANNOT_COLORTYPE_FPDFANNOT_COLORTYPE_Color: FPDFANNOT_COLORTYPE =
    0;
pub const FPDFANNOT_COLORTYPE_FPDFANNOT_COLORTYPE_InteriorColor:
    FPDFANNOT_COLORTYPE = 1;
...
unsafe extern "C" {
    pub fn FPDFPage_RemoveAnnot(
        page: FPDF_PAGE,
        index: ::std::os::raw::c_int,
    ) -> FPDF_BOOL;
}
unsafe extern "C" {
    pub fn FPDFAnnot_GetSubtype(
        annot: FPDF_ANNOTATION,
...
unsafe extern "C" {
    pub fn FPDFAnnot_GetObjectCount(
        annot: FPDF_ANNOTATION,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFAnnot_GetInkListCount(
        annot: FPDF_ANNOTATION,
    ) -> ::std::os::raw::c_ulong;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFAnnot_GetFocusableSubtypesCount(
        hHandle: FPDF_FORMHANDLE,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDFAnnot_GetObjNum(annot: FPDF_ANNOTATION)
    -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn FPDF_StructTree_CountChildren(
...
unsafe extern "C" {
    pub fn FPDFClipPath_CountPaths(
