...
//! at compile time. This avoids rpath issues when `docparse` is used as a
...
/// Resolves a required entry point from the retained native library.
macro_rules! load_fn {
    ($lib:expr, $name:literal) => {{
        // SAFETY: The destination PdfiumBindings field supplies the exact
        // function pointer type expected for this exported PDFium symbol.
        let sym = unsafe { $lib.get($name.as_bytes())? };
        *sym
    }};
}
...
macro_rules! load_fn_opt {
    ($lib:expr, $name:literal) => {{
        // SAFETY: The destination Option field supplies the exact function
        // pointer type expected for this optional exported PDFium symbol.
        unsafe { $lib.get($name.as_bytes()) }.ok().map(|sym| *sym)
    }};
}
...
pub struct PdfiumBindings {
    ...
    pub FPDF_GetFormType:
        unsafe extern "C" fn(FPDF_DOCUMENT) -> std::os::raw::c_int,
    pub FPDFDOC_InitFormFillEnvironment:
        unsafe extern "C" fn(
            FPDF_DOCUMENT,
            *mut FPDF_FORMFILLINFO,
        ) -> FPDF_FORMHANDLE,
    ...
    pub FORM_OnBeforeClosePage:
        unsafe extern "C" fn(FPDF_PAGE, FPDF_FORMHANDLE),
    ...
    pub FORM_DoPageAAction:
        unsafe extern "C" fn(FPDF_PAGE, FPDF_FORMHANDLE, std::os::raw::c_int),
    ...
    pub FPDF_GetFileVersion: unsafe extern "C" fn(
        FPDF_DOCUMENT,
        *mut std::os::raw::c_int,
    ) -> FPDF_BOOL,
    pub FPDF_GetSecurityHandlerRevision:
        unsafe extern "C" fn(FPDF_DOCUMENT) -> std::os::raw::c_int,
    pub FPDF_GetDocPermissions:
        unsafe extern "C" fn(FPDF_DOCUMENT) -> std::os::raw::c_ulong,
    ...
    pub FPDF_GetSignatureCount:
        Option<unsafe extern "C" fn(FPDF_DOCUMENT) -> std::os::raw::c_int>,
    pub FPDF_GetSignatureObject: Option<
        unsafe extern "C" fn(
            FPDF_DOCUMENT,
            std::os::raw::c_int,
        ) -> FPDF_SIGNATURE,
    ...
    pub FPDF_GetPageSizeByIndexF: unsafe extern "C" fn(
        FPDF_DOCUMENT,
        std::os::raw::c_int,
        *mut FS_SIZEF,
    ) -> FPDF_BOOL,
    ...
    // -- Page --
    pub FPDF_LoadPage:
        unsafe extern "C" fn(FPDF_DOCUMENT, std::os::raw::c_int) -> FPDF_PAGE,
    ...
    pub FPDFPage_CountObjects:
        unsafe extern "C" fn(FPDF_PAGE) -> std::os::raw::c_int,
    pub FPDFPage_GetObject:
        unsafe extern "C" fn(FPDF_PAGE, std::os::raw::c_int) -> FPDF_PAGEOBJECT,
    ...
    pub FPDFImageObj_GetRenderedBitmap: unsafe extern "C" fn(
        ...
        -> FPDF_BITMAP,
    pub FPDFImageObj_GetImageDataDecoded:
        unsafe extern "C" fn(
            FPDF_PAGEOBJECT,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
        ) -> std::os::raw::c_ulong,
    pub FPDFImageObj_GetImageDataRaw:
        unsafe extern "C" fn(
            FPDF_PAGEOBJECT,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
    ...
    pub FPDFImageObj_GetImageFilterCount:
        unsafe extern "C" fn(FPDF_PAGEOBJECT) -> std::os::raw::c_int,
    pub FPDFImageObj_GetImageFilter:
        unsafe extern "C" fn(
            FPDF_PAGEOBJECT,
            std::os::raw::c_int,
            *mut std::os::raw::c_void,
    ...
    pub FPDFImageObj_GetImageMetadata: unsafe extern "C" fn(
        FPDF_PAGEOBJECT,
        FPDF_PAGE,
        *mut FPDF_IMAGEOBJ_METADATA,
    ) -> FPDF_BOOL,
    ...
    pub FPDFPageObj_GetStrokeWidth:
        unsafe extern "C" fn(FPDF_PAGEOBJECT, *mut f32) -> FPDF_BOOL,
    pub FPDFPath_GetDrawMode: unsafe extern "C" fn(
        FPDF_PAGEOBJECT,
        *mut std::os::raw::c_int,
        *mut FPDF_BOOL,
    ) -> FPDF_BOOL,
    pub FPDFFormObj_CountObjects:
        unsafe extern "C" fn(FPDF_PAGEOBJECT) -> std::os::raw::c_int,
    pub FPDFFormObj_GetObject: unsafe extern "C" fn(
        FPDF_PAGEOBJECT,
        std::os::raw::c_ulong,
    ) -> FPDF_PAGEOBJECT,
    pub FPDFPath_CountSegments:
        unsafe extern "C" fn(FPDF_PAGEOBJECT) -> std::os::raw::c_int,
    pub FPDFPath_GetPathSegment: unsafe extern "C" fn(
        FPDF_PAGEOBJECT,
        std::os::raw::c_int,
    ) -> FPDF_PATHSEGMENT,
    pub FPDFPathSegment_GetPoint:
        unsafe extern "C" fn(FPDF_PATHSEGMENT, *mut f32, *mut f32) -> FPDF_BOOL,
    pub FPDFPathSegment_GetType:
        unsafe extern "C" fn(FPDF_PATHSEGMENT) -> std::os::raw::c_int,
    pub FPDFPathSegment_GetClose:
        unsafe extern "C" fn(FPDF_PATHSEGMENT) -> FPDF_BOOL,
    ...
    pub FPDFFont_GetEncoding: unsafe extern "C" fn(
        ...
        *mut std::os::raw::c_char,
        ...
        -> std::os::raw::c_ulong,
    pub FPDFFont_GetCharGlyphIndex:
        unsafe extern "C" fn(FPDF_FONT, u32) -> std::os::raw::c_int,
    pub FPDFFont_GetFontData: unsafe extern "C" fn(
        FPDF_FONT,
        *mut u8,
        usize,
        *mut usize,
    ...
    pub FPDFBookmark_GetTitle: unsafe extern "C" fn(
        ...
        *mut std::os::raw::c_void,
        ...
        -> std::os::raw::c_ulong,
    pub FPDFBookmark_GetDest:
        unsafe extern "C" fn(FPDF_DOCUMENT, FPDF_BOOKMARK) -> FPDF_DEST,
    pub FPDFBookmark_GetAction:
        unsafe extern "C" fn(FPDF_BOOKMARK) -> FPDF_ACTION,
    pub FPDFAction_GetDest:
    ...
    pub FPDFAction_GetURIPath: unsafe extern "C" fn(
        ...
        *mut std::os::raw::c_void,
        ...
        -> std::os::raw::c_ulong,
    pub FPDFLink_Enumerate: unsafe extern "C" fn(
        FPDF_PAGE,
        *mut std::os::raw::c_int,
        *mut FPDF_LINK,
    ) -> FPDF_BOOL,
    pub FPDFLink_GetAction: unsafe extern "C" fn(FPDF_LINK) -> FPDF_ACTION,
    pub FPDFLink_GetAnnotRect:
        unsafe extern "C" fn(FPDF_LINK, *mut FS_RECTF) -> FPDF_BOOL,
    pub FPDFLink_CountQuadPoints:
        unsafe extern "C" fn(FPDF_LINK) -> std::os::raw::c_int,
    pub FPDFLink_GetQuadPoints: unsafe extern "C" fn(
        FPDF_LINK,
        std::os::raw::c_int,
        *mut FS_QUADPOINTSF,
    ) -> FPDF_BOOL,
    // -- Annotations --
    pub FPDFPage_GetAnnotCount:
        unsafe extern "C" fn(FPDF_PAGE) -> std::os::raw::c_int,
    pub FPDFPage_GetAnnot:
        unsafe extern "C" fn(FPDF_PAGE, std::os::raw::c_int) -> FPDF_ANNOTATION,
    pub FPDFPage_CloseAnnot: unsafe extern "C" fn(FPDF_ANNOTATION),
    pub FPDFAnnot_GetSubtype:
        unsafe extern "C" fn(FPDF_ANNOTATION) -> FPDF_ANNOTATION_SUBTYPE,
    pub FPDFAnnot_GetStringValue: unsafe extern "C" fn(
        ...
        *mut FPDF_WCHAR,
        ...
        -> std::os::raw::c_ulong,
    pub FPDFAnnot_GetRect:
        unsafe extern "C" fn(FPDF_ANNOTATION, *mut FS_RECTF) -> FPDF_BOOL,
    pub FPDFAnnot_HasAttachmentPoints:
        unsafe extern "C" fn(FPDF_ANNOTATION) -> FPDF_BOOL,
    pub FPDFAnnot_CountAttachmentPoints:
        unsafe extern "C" fn(FPDF_ANNOTATION) -> usize,
    pub FPDFAnnot_GetAttachmentPoints: unsafe extern "C" fn(
        FPDF_ANNOTATION,
        usize,
        *mut FS_QUADPOINTSF,
    ) -> FPDF_BOOL,
    pub FPDFAnnot_GetLink: unsafe extern "C" fn(FPDF_ANNOTATION) -> FPDF_LINK,
    pub FPDFAnnot_GetLinkedAnnot: unsafe extern "C" fn(
        FPDF_ANNOTATION,
        FPDF_BYTESTRING,
    ) -> FPDF_ANNOTATION,
    pub FPDFAnnot_GetObjNum:
        unsafe extern "C" fn(FPDF_ANNOTATION) -> std::os::raw::c_int,
    pub FPDFAnnot_GetFlags:
        unsafe extern "C" fn(FPDF_ANNOTATION) -> std::os::raw::c_int,
    pub FPDFAnnot_SetFlags: Option<
        unsafe extern "C" fn(FPDF_ANNOTATION, std::os::raw::c_int) -> FPDF_BOOL,
    >,
    pub FPDFAnnot_GetObjectCount:
        unsafe extern "C" fn(FPDF_ANNOTATION) -> std::os::raw::c_int,
    pub FPDFAnnot_GetObject: unsafe extern "C" fn(
        FPDF_ANNOTATION,
        std::os::raw::c_int,
    ) -> FPDF_PAGEOBJECT,
    ...
    pub FPDFAnnot_GetFormFieldName:
        unsafe extern "C" fn(
            FPDF_FORMHANDLE,
            FPDF_ANNOTATION,
            *mut FPDF_WCHAR,
    ...
    pub FPDFAnnot_GetFormFieldAlternateName:
        unsafe extern "C" fn(
            FPDF_FORMHANDLE,
            FPDF_ANNOTATION,
            *mut FPDF_WCHAR,
    ...
    pub FPDFAnnot_GetFormFieldType: unsafe extern "C" fn(
        FPDF_FORMHANDLE,
        FPDF_ANNOTATION,
    )
        -> std::os::raw::c_int,
    pub FPDFAnnot_GetFormFieldValue:
        unsafe extern "C" fn(
            FPDF_FORMHANDLE,
            FPDF_ANNOTATION,
            *mut FPDF_WCHAR,
    ...
    pub FPDFAnnot_GetFormFieldExportValue:
        unsafe extern "C" fn(
            FPDF_FORMHANDLE,
            FPDF_ANNOTATION,
            *mut FPDF_WCHAR,
    ...
    pub FPDFAnnot_GetOptionCount: unsafe extern "C" fn(
        FPDF_FORMHANDLE,
        FPDF_ANNOTATION,
    )
        -> std::os::raw::c_int,
    pub FPDFAnnot_GetOptionLabel: unsafe extern "C" fn(
        ...
        *mut FPDF_WCHAR,
        ...
        -> std::os::raw::c_ulong,
    pub FPDFAnnot_IsOptionSelected: unsafe extern "C" fn(
        FPDF_FORMHANDLE,
        FPDF_ANNOTATION,
        std::os::raw::c_int,
    ) -> FPDF_BOOL,
    pub FPDFAnnot_IsChecked:
        unsafe extern "C" fn(FPDF_FORMHANDLE, FPDF_ANNOTATION) -> FPDF_BOOL,
    ...
    // -- Structure tree --
    pub FPDF_StructTree_GetForPage:
        unsafe extern "C" fn(FPDF_PAGE) -> FPDF_STRUCTTREE,
    ...
    pub FPDF_StructElement_GetType:
        unsafe extern "C" fn(
            FPDF_STRUCTELEMENT,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
        ) -> std::os::raw::c_ulong,
    pub FPDF_StructElement_GetAltText:
        unsafe extern "C" fn(
            FPDF_STRUCTELEMENT,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
        ) -> std::os::raw::c_ulong,
    pub FPDF_StructElement_GetActualText:
        unsafe extern "C" fn(
            FPDF_STRUCTELEMENT,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
    ...
    pub FPDF_StructElement_GetID: unsafe extern "C" fn(
        ...
        *mut std::os::raw::c_void,
        ...
        -> std::os::raw::c_ulong,
    pub FPDF_StructElement_GetTitle:
        unsafe extern "C" fn(
            FPDF_STRUCTELEMENT,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
    ...
    pub FPDF_StructElement_Attr_GetValue:
        unsafe extern "C" fn(
            FPDF_STRUCTELEMENT_ATTR,
            FPDF_BYTESTRING,
    ...
    pub FPDF_StructElement_Attr_GetStringValue:
        unsafe extern "C" fn(
            FPDF_STRUCTELEMENT_ATTR_VALUE,
            *mut std::os::raw::c_void,
            std::os::raw::c_ulong,
...
impl PdfiumBindings {
    fn load(lib: Library) -> Result<Self, libloading::Error> {
        Ok(Self {
            ...
            FPDFDOC_InitFormFillEnvironment: load_fn!(
                lib,
                "FPDFDOC_InitFormFillEnvironment"
            ),
            FPDFDOC_ExitFormFillEnvironment: load_fn!(
                lib,
            ...
            FORM_DoDocumentOpenAction: load_fn!(
                lib,
            ...
            FPDF_GetSecurityHandlerRevision: load_fn!(
                lib,
            ...
            FPDF_GetSignatureObject: load_fn_opt!(
                lib,
                "FPDF_GetSignatureObject"
            ),
            FPDFSignatureObj_GetByteRange: load_fn_opt!(
                lib,
            ...
            FPDFImageObj_GetRenderedBitmap: load_fn!(
                lib,
                "FPDFImageObj_GetRenderedBitmap"
            ),
            FPDFImageObj_GetImageDataDecoded: load_fn!(
                lib,
                "FPDFImageObj_GetImageDataDecoded"
            ),
            FPDFImageObj_GetImageDataRaw: load_fn!(
                lib,
                "FPDFImageObj_GetImageDataRaw"
            ),
            FPDFImageObj_GetImageFilterCount: load_fn!(
                lib,
                "FPDFImageObj_GetImageFilterCount"
            ),
            FPDFImageObj_GetImageFilter: load_fn!(
                lib,
                "FPDFImageObj_GetImageFilter"
            ),
            FPDFImageObj_GetImageMetadata: load_fn!(
                lib,
                "FPDFImageObj_GetImageMetadata"
            ),
            FPDFImageObj_GetImagePixelSize: load_fn!(
                lib,
            ...
            FPDFPageObj_GetStrokeWidth: load_fn!(
                lib,
            ...
            FPDFText_GetCharInfoBatch: load_fn_opt!(
                lib,
                "FPDFText_GetCharInfoBatch"
            ),
            ...
            FPDFTextObj_GetTextRenderMode: load_fn!(
                lib,
            ...
            FPDFFont_GetGlyphWidthFromCharCode: load_fn!(
                lib,
                "FPDFFont_GetGlyphWidthFromCharCode"
            ),
            FPDFFont_GetGlyphPathFromCharCode: load_fn!(
                lib,
                "FPDFFont_GetGlyphPathFromCharCode"
            ),
            FPDFGlyphPath_CountGlyphSegments: load_fn!(
                lib,
            ...
            FPDFFont_GetCharGlyphName: load_fn!(
                lib,
                "FPDFFont_GetCharGlyphName"
            ),
            FPDFFont_GetEncoding: load_fn!(lib, "FPDFFont_GetEncoding"),
            FPDFFont_GetCharGlyphIndex: load_fn!(
                lib,
                "FPDFFont_GetCharGlyphIndex"
            ),
            FPDFFont_GetFontData: load_fn!(lib, "FPDFFont_GetFontData"),

            FPDFBookmark_GetFirstChild: load_fn!(
                lib,
                "FPDFBookmark_GetFirstChild"
            ),
            FPDFBookmark_GetNextSibling: load_fn!(
                lib,
            ...
            FPDFAnnot_HasAttachmentPoints: load_fn!(
                lib,
                "FPDFAnnot_HasAttachmentPoints"
            ),
            FPDFAnnot_CountAttachmentPoints: load_fn!(
                lib,
                "FPDFAnnot_CountAttachmentPoints"
            ),
            FPDFAnnot_GetAttachmentPoints: load_fn!(
                lib,
            ...
            FPDFAnnot_GetFormFieldFlags: load_fn!(
                lib,
                "FPDFAnnot_GetFormFieldFlags"
            ),
            FPDFAnnot_GetFormFieldName: load_fn!(
                lib,
            ...
            FPDFAnnot_GetFormFieldType: load_fn!(
                lib,
                "FPDFAnnot_GetFormFieldType"
            ),
            FPDFAnnot_GetFormFieldValue: load_fn!(
                lib,
                "FPDFAnnot_GetFormFieldValue"
            ),
            FPDFAnnot_GetFormFieldExportValue: load_fn!(
                lib,
            ...
            FPDFAnnot_IsOptionSelected: load_fn!(
                lib,
                "FPDFAnnot_IsOptionSelected"
            ),
            FPDFAnnot_IsChecked: load_fn!(lib, "FPDFAnnot_IsChecked"),
            FPDFAnnot_GetFormControlCount: load_fn!(
                lib,
                "FPDFAnnot_GetFormControlCount"
            ),
            FPDFAnnot_GetFormControlIndex: load_fn!(
                lib,
                "FPDFAnnot_GetFormControlIndex"
            ),
            FPDFDest_GetDestPageIndex: load_fn!(
                lib,
                "FPDFDest_GetDestPageIndex"
            ),
            FPDFDest_GetLocationInPage: load_fn!(
                lib,
                "FPDFDest_GetLocationInPage"
            ),

            FPDF_StructTree_GetForPage: load_fn!(
                lib,
                "FPDF_StructTree_GetForPage"
            ),
            FPDF_StructTree_Close: load_fn!(lib, "FPDF_StructTree_Close"),
            FPDF_StructTree_CountChildren: load_fn!(
                lib,
                "FPDF_StructTree_CountChildren"
            ),
            FPDF_StructTree_GetChildAtIndex: load_fn!(
                lib,
                "FPDF_StructTree_GetChildAtIndex"
            ),
            FPDF_StructElement_GetType: load_fn!(
                lib,
                "FPDF_StructElement_GetType"
            ),
            FPDF_StructElement_GetAltText: load_fn!(
                lib,
                "FPDF_StructElement_GetAltText"
            ),
            FPDF_StructElement_GetActualText: load_fn!(
                lib,
                "FPDF_StructElement_GetActualText"
            ),
            FPDF_StructElement_GetID: load_fn!(lib, "FPDF_StructElement_GetID"),
            FPDF_StructElement_GetTitle: load_fn!(
                lib,
                "FPDF_StructElement_GetTitle"
            ),
            FPDF_StructElement_CountChildren: load_fn!(
                lib,
                "FPDF_StructElement_CountChildren"
            ),
            FPDF_StructElement_GetChildAtIndex: load_fn!(
                lib,
            ...
            FPDF_StructElement_GetChildObjNum: load_fn!(
                lib,
            ...
            FPDF_StructElement_Attr_GetCount: load_fn!(
                lib,
                "FPDF_StructElement_Attr_GetCount"
            ),
            FPDF_StructElement_Attr_GetName: load_fn!(
                lib,
                "FPDF_StructElement_Attr_GetName"
            ),
            FPDF_StructElement_Attr_GetValue: load_fn!(
                lib,
                "FPDF_StructElement_Attr_GetValue"
            ),
            FPDF_StructElement_Attr_GetType: load_fn!(
                lib,
...
use crate::wasm_compat::{dylib_name, search_paths};
...
pub fn load(lib_path: &Path) -> Result<(), String> {
    ...
    let lib = unsafe { Library::new(lib_path) }.map_err(|e| {
        format!("failed to load pdfium from {}: {e}", lib_path.display())
    })?;
