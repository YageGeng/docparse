//! Plus-L foreground cropping, normalization, and batching over owned RGB crops.
use crate::FormulaError;
use docparse_layout::PageImage;
use ndarray::Array4;
use std::sync::Arc;

/// Pinned Plus-L preprocessing, adapted from Apache-2.0 OAR-OCR formula_preprocess.rs.
