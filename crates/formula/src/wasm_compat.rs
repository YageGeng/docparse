...
use crate::{
    FormulaArtifacts, FormulaError, PpFormulaNetEngine, model::FormulaDecoder,
    ...
    impl SessionRunner {
        ...
        pub(crate) async fn load(
            ...
            if coreml_incompatible {
                tracing::warn!(
                    "PP-FormulaNet_plus-L uses the CPU compatibility executor on Apple: the pinned CoreML export fails repeated inference"
                );
            }
