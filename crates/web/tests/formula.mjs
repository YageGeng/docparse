  ...
  const result = await page.evaluate(async provider => {
    ...
    try {
      ...
      parser = await createParser({ executionProvider: provider, allowCpuFallback: false,
        ...
        formulaArtifacts: { kind: "urls", model: "/models/pp-formulanet-plus-l/inference.onnx", tokenizer: "/models/pp-formulanet-plus-l/tokenizer.json", manifest: "/models/pp-formulanet-plus-l/model-manifest.json" },
