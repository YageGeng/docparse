...
export type FormulaEngineOptions =
  | { type: "pp"; cpu_session_size?: number; gpu_session_size?: number; cpu_intra_threads?: number }
  | { type: "texo"; cpu_session_size?: number; gpu_session_size?: number; cpu_intra_threads?: number }
